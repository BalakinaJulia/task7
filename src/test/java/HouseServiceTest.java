...
import static House.HouseService.*;
...
class TestHouseService {
    ...
    public static void createTestsDir() {
        ...
        testsDir.mkdirs();
        p1 = new Person("Лящук", "А.", "С.", "LocalDate.of(2001, 10, 22)");
        p2 = new Person("Иванов", "Д.", "В.", "LocalDate.of(1987, 11, 29)");
        p3 = new Person("Х", "Ю.", "М.", "LocalDate.of(1990, 01, 19)");
